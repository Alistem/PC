...
void MainWindow::on_action_about_triggered()
{
    QMessageBox::about(this, tr("Astra Animator"),
            tr("Эта программа предназначена для работы с контроллерами семейства Астра. Она позволяет создавать анимацию для контроллера, редактировать её, сохранять или записывать в контроллер. Мы рады, что Вы воспользовались нашим продуктом. Дополнительную информацию Вы можете найти у нас на сайте: www.alistem.ru. Спасибо!"));
}
